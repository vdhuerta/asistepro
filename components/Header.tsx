  ...
  return (
    <header className="w-full mb-12 mt-14 sm:mt-12 relative">
      <NeumorphicCard className="bg-rose-100 p-6 pt-10 text-center">
        <div className="absolute -top-[64px] left-1/2 -translate-x-1/2 w-20 h-20 bg-rose-100 rounded-full p-2 shadow-[5px_5px_10px_#d1c7c8,-5px_-5px_10px_#ffffff] flex items-center justify-center">
            <img
